...
import buzz_findr_text_bg_removed from './buzz_findr_text_bg_removed.png'
            ...
            {localStorage.getItem("accountType") == "influencer" ? (
                <aside>
                    <div className="logo">
                        ...
                        <img src={buzz_findr_text_bg_removed} width="100"/>
                    </div>
                    <nav>
                ...
                <aside>
                    <div className="logo">
                        <img src={buzz_findr_text_bg_removed} width="100" height="300"/>
                    </div>
                    <nav>
                        <div className="nav-btn" onClick={() => {
                            navigate("/campaigns");
